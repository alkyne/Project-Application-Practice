...
<body>
	...
	<form class="container container-fluid" style="padding: 80px; width: 600px;" action="signin.jsp" method="post">
		...
		<fieldset>
			...
			<div class="form-group col">
				<label>아이디</label> <input type="text" class="form-control" placeholder="아이디를 입력해주세요" name="id">
			</div>


			<div class="form-group col">
				<label>Password</label> <input type="password" class="form-control" placeholder="패스워드를 입력해주세요" name="pw">
			</div>
