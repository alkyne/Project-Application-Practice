...
<body>
			...
			<div class="col-8" style="display: inline;">
				<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
					...
					<ul class="navbar-nav">
						...
						%>
							<li class="nav-item active"><a class="nav-link"
								href="mypage.jsp">MyPage</a></li>
							<li class="nav-item active"><a class="nav-link"
								href="sitemap.jsp">사이트맵</a></li>
						
						<form class="form-inline my-2 my-lg-0" action="#">
							<input class="form-control mr-sm-2" type="text" placeholder="검색">
							<button class="btn btn-secondary my-2 my-sm-0" id="search"
				...
				<div class="row">
					<div class="col-7"></div>
					<div class="col-5">
						<div class="alert alert-dismissible alert-warning pull-right"
							style="display: none">
	...
	<div class="container container-fluid" style="margin: auto">
		...
		<nav class="nav nav-pills nav-fill">
			<span style="width: 60px;"></span> <a href="with_board/index.jsp"><button
					type="button" class="btn btn-primary">동행 게시판</button></a> <span
				style="width: 85px;"></span> <span class="dropdown">
				<button class="btn btn-lg btn-primary dropdown-toggle" type="button"
					data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
					아시아</button>
				<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
					<a class="dropdown-item" href="#">중국</a> <a class="dropdown-item"
						href="#">일본</a> <a class="dropdown-item" href="#">베트남</a> <a
						class="dropdown-item" href="#">필리핀</a> <a class="dropdown-item"
						href="#">태국</a>
				</div>
				...
				<button class="btn btn-lg btn-primary dropdown-toggle" type="button"
					...
					유럽</button>
				<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
					<a class="dropdown-item" href="#">영국</a> <a class="dropdown-item"
						href="#">북유럽</a> <a class="dropdown-item" href="#">남유럽</a> <a
						class="dropdown-item" href="#">동유럽</a> <a class="dropdown-item"
						href="#">서유럽</a>
				</div>
			</span> <span style="width: 85px;"></span> <span class="dropdown">
				<button class="btn btn-lg btn-primary dropdown-toggle" type="button"
					...
					미주/중남미</button>
				<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
					<a class="dropdown-item" href="#">미국</a> <a class="dropdown-item"
						href="#">브라질/아르헨티나/칠레</a> <a class="dropdown-item" href="#">캐나다</a>
				</div>
			</span> <span style="width: 85px;"></span> <span class="dropdown">
				<button class="btn btn-lg btn-primary dropdown-toggle" type="button"
					data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
					오세아니아</button>
				<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
					<a class="dropdown-item" href="#">오스트레일리아</a> <a
						class="dropdown-item" href="#">뉴질랜드</a>
				</div>
		...
		<div id="carouselExampleIndicators" class="carousel slide"
			data-ride="carousel" style="margin: auto">
	...
	<div class="container container-fluid">
		<div class="row">
			<div class="col">
				...
				<table
					class="table table-hover table-hover table-striped table-responsive-sm">
					<thead>
			...
			<div class="row py-3 d-flex align-items-center">
				...
				<div class="col-md-8 col-lg-8">
					...
					<p class="text-center text-md-left grey-text">
						© 2018 Copyright: <a href="#"><strong>전문프로젝트 9조 / 전희지
								/ 강경민 / 최동민 </strong></a>
					</p>
