...
<div class="container container-fluid">
    <div class="row" style="background-color: #78C2AD;">
        <div class="col-4" style="display: inline"><span id="typed2"></span></div>
...
<div class="container container-fluid" style="margin: auto">
    ...
    <nav class="nav nav-pills nav-fill">
        ...
        <a href="with_board/index.jsp"><button type="button" class="btn btn-primary">동행 게시판</button></a>
        ...
        <span class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <a class="dropdown-item" href="#">중국</a>
                <a class="dropdown-item" href="#">일본</a>
                <a class="dropdown-item" href="#">베트남</a>
                <a class="dropdown-item" href="#">필리핀</a>
                <a class="dropdown-item" href="#">태국</a>
            </div>
        </span>
        <span style="width:85px;"></span>
        <span class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                ...
                <a class="dropdown-item" href="#">북유럽</a>
                <a class="dropdown-item" href="#">남유럽</a>
                <a class="dropdown-item" href="#">동유럽</a>
                <a class="dropdown-item" href="#">서유럽</a>
            </div>
        </span>
        <span style="width:85px;"></span>
        <span class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                ...
                <a class="dropdown-item" href="#">브라질/아르헨티나/칠레</a>
                <a class="dropdown-item" href="#">캐나다</a>
            </div>
        </span>
        <span style="width:85px;"></span>
        <span class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <a class="dropdown-item" href="#">오스트레일리아</a>
                <a class="dropdown-item" href="#">뉴질랜드</a>
            </div>
        </span>
    ...
    <div class="container text-center text-md-left">
        ...
        <div class="row text-center text-md-left mt-3 pb-3">
            ...
            <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mt-3">
                ...
                <p><a href="#!">후기 게시판</a></p>
                <p><a href="#!">동행 게시판</a></p>
                <p><a href="#!">여행 숙소 추천</a></p>
                <p><a href="#!">여행 맛집 게시판</a></p>
            </div>
            <hr class="w-100 clearfix d-md-none">

            <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3">
                <h6 class="text-uppercase mb-4 font-weight-bold">Contact</h6>
                <p><i class="fa fa-home mr-3"></i> 충북대학교 소프트웨어학과</p>
                <p><i class="fa fa-envelope mr-3"></i>전문프로젝트 9조</p>
                <p><i class="fa fa-envelope mr-3"></i>팀장 전희지 (2016039034)</p>
                <p><i class="fa fa-phone mr-3"></i> 010-1234-5678</p>
            </div>
        ...
        <div class="row py-3 d-flex align-items-center">
            ...
            <div class="col-md-8 col-lg-8">
                ...
                <p class="text-center text-md-left grey-text">© 2018 Copyright: <a href="#"><strong>전문프로젝트 9조 / 전희지 / 강경민 / 최동민 </strong></a> </p>
